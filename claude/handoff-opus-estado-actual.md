...
**Fecha:** 15 sept 2026 — **última actualización: ronda H-1**, que cerró **A2** y
...
| **P18** — el rescate PS-1007 y la procedencia de las copias de `app.asar` | **PENDIENTE — INTEGRIDAD** (sale de P22) | P22 **no** lo toca: la copia se sigue eligiendo por la fecha del nombre, sin versión ni procedencia, en una carpeta que puede ser compartida |
| **P18** — `Restaurar-backup.bat` y la carpeta por defecto | **PENDIENTE — INTEGRIDAD** (registrado al cerrar P9) | Con `location.json` en una sola línea o en UTF-16, el rescate **manual** elige la carpeta por defecto, donde hay un `app.asar.bak` del 26/08. No se corrige dentro de P9. Ver `pendientes-abiertos.md` §P18–P21 |
