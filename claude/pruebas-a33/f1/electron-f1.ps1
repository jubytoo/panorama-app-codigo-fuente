# ---------------------------------------------------------------------------
# F1 - inyeccion HTML en la app REAL, dentro de un sandbox artificial.
#   modo a  proyecto importado con payloads inocuos; dashboard (varias pasadas
#           de UI), escalada NO destructiva (psConfirm sustituido responde NO),
#           window.open, barreras, Preparacion, Evaluacion, lanzador
#   modo b  reinicio: los payloads guardados vuelven a ejecutarse?
#   modo c  titulo malicioso horneado en projects/<id>/dashboard.html;
#           lanzador; Directorio (data-dedic)
#
# Descriptivo: mide, no exige ningun cambio. Sin red. NO toca la BD viva ni G:.
