...
`SHA256SUMS.txt` (en esta misma carpeta) lista el **SHA-256 de los 258
...
Última verificación (18 sept 2026, tras IMPLEMENTAR P22): **258
listados, 0 faltan, 0 difieren, 0 `.sqlite3`**, 4 636 450 bytes. La
