# ---------------------------------------------------------------------------
# B4 - projects:reorder en la app REAL, dentro de un sandbox artificial:
#   RE1  un reordenado de 3 proyectos = UNA sola publicacion del .sqlite3
#   RE2  con la publicacion fallando: rechazo al renderer, orden intacto,
#        linea en app.log sin la lista de proyectos ni rutas
#   RE3  la operacion siguiente funciona, y el lanzador ve el orden nuevo
#   RE4  validacion de entrada en vivo
#
# Los proyectos son de PRUEBA, creados por el propio arnes. No se toca la BD
# viva ni el orden productivo real.
#
...
$S = Join-Path $env:TEMP '_a33-b4-real'
if ($S -notlike '*_a33-b4-real*') { throw "sandbox inesperado: $S" }
...
Write-Output "==================== APP REAL (projects:reorder) ===================="
...
Write-Output ""
Write-Output "======================================================================"
Write-Output "  B4 ELECTRON REAL (reorder): $totOK OK / $totFALLO FALLOS"
Write-Output "======================================================================"
